        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="login.php">
                    ...
                    <div class="col-12">
                      ...
                      <input name="email" required class="form-control form-control-lg"
              ...
              <div class="credits">
                Designed by <a href="https://github.com/soulaimane-elbouzdoudi">Soulaimane Elbouzdoudi</a>
              </div>
